...
local/SampleData-water-data.tsv: src/submission_schema/schema/submission_schema.yaml \
...
local/SampleData-water-data.db: src/submission_schema/schema/submission_schema.yaml \
local/SampleData-water-data.tsv
