...
- analysis_type:
  ...
  depth: '111'
  elev: 111
  env_broad_scale: Code Generation [OP:8888]
  env_local_scale: Code Generation [OP:8888]
  env_medium: Code Generation [OP:8888]
  env_package: plant-associated
  geo_loc_name: 'USA: Philadelphia, Pennsylvania'
  growth_facil: field
  lat_lon: 77 88
...
```
## SampleData-jgi_mt_data-minimal
### Input
```yaml
jgi_mt_data:
- analysis_type:
...
```
## SampleData-jgi_mt_data-string-dnase_rna
### Input
```yaml
jgi_mt_data:
- analysis_type:
  - metatranscriptomics
  dnase_rna: Not Applicable
  proposal_rna: '504000'
  rna_concentration: 100.3
  rna_cont_type: tube
  rna_cont_well: H7
...
```
## SampleData-jgi_mt_data-in-bucket
### Input
```yaml
jgi_mt_data:
- analysis_type:
...
```
## SampleData-jgi_mt_data-illegal-string-rna_concentration
### Input
```yaml
jgi_mt_data:
- analysis_type:
...
```
## SampleData-jgi_mt_data-illegal-rna_sample_format
### Input
```yaml
jgi_mt_data:
- analysis_type:
  ...
  rna_project_contact: Leslie Ann Levine
  rna_samp_id: '123456'
  rna_sample_format: Phosphate Buffered Saline
  rna_sample_name: JGI_lagoon_14343
  rna_seq_project: '123456789'
  rna_seq_project_name: JGI Lagoon metatranscritpomics
  rna_seq_project_pi: Patty Smith
...
```
## SampleData-jgi_mt_data-capitalized-dnase_rna
### Input
```yaml
jgi_mt_data:
- analysis_type:
...
```
## SampleData-jgi_mt_data-illegal-string-rna_cont_well
### Input
```yaml
jgi_mt_data:
- analysis_type:
...
```
## SampleData-jgi_mt_data-exceeds-char-limit-rna_container_id
### Input
```yaml
jgi_mt_data:
- analysis_type:
  ...
  rna_cont_type: plate
  rna_cont_well: H7
  rna_container_id: Columbia_River_Watershed_MT_052292
  rna_isolate_meth: phenol/cloroform extraction
  rna_project_contact: Leslie Ann Levine
  rna_samp_id: '123456'
  rna_sample_format: MDA reaction buffer
...
```
## SampleData-jgi_mt_data-capital-rna_cont_type
### Input
```yaml
jgi_mt_data:
- analysis_type:
...
```
## SampleData-plant-associated-illegally-high-lat
### Input
```yaml
plant_associated_data:
- analysis_type:
  ...
  env_medium: Code Generation [OP:8888]
  env_package: plant-associated
  geo_loc_name: our first houseplant is dying
  growth_facil: field
  lat_lon: 111 88
  samp_name: our first houseplant is dying
  samp_store_temp: 20 C
...
```
## SampleData-jgi_mt_data-missing-colon-source_mat_id
### Input
```yaml
jgi_mt_data:
- analysis_type:
...
```
## SampleData-plant-assoc--with-flavor
### Input
```yaml
plant_associated_data:
- analysis_type:
